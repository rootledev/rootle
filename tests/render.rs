...
fn commit_viewer_dive_chain() {
    ...
    app.handle_app_event(rootle::event::AppEvent::LogLoaded {
        path: "Cargo.toml".into(),
        entries: vec![rootle::provider::LogEntry {
    ...
    app.handle_app_event(rootle::event::AppEvent::CommitLoaded {
        sha: "feedface1234".into(),
        detail: Ok(rootle::provider::CommitDetail {
            sha: "feedface1234".into(),
            author: "tarek".into(),
            date: "2026-09-06".into(),
            ...
            files: vec![
                rootle::provider::CommitFile {
                    path: "src/lib.rs".into(),
                    status: rootle::provider::FileStatus::Modified,
                    additions: Some(2),
                    deletions: Some(1),
                    patch: Some(
                        "@@ -10,4 +10,5 @@\n context line\n-old line\n+new line one\n+new line two\n context tail\n".into(),
                ...
                rootle::provider::CommitFile {
                    path: "README.md".into(),
                    status: rootle::provider::FileStatus::Added,
                    additions: Some(5),
                    deletions: None,
