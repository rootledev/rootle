...
use rootle_provider::{ProviderError, SearchItem};

#[derive(Debug)]
pub enum AppEvent {
    SearchResults {
        gen_id: crate::request::SearchGeneration,
    ...
    CommitLoaded {
        ...
        detail: Result<rootle_provider::CommitDetail, rootle_provider::ProviderError>,
    },
    BlameLoaded {
        path: String,
    ...
    LastCommitLoaded {
        repo: String,
        path: String,
        entry: Option<rootle_provider::LogEntry>,
    },
}
